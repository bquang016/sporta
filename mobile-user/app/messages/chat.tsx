...
export default function ChatDetailScreen() {
  ...
  // Read chat partner details from route params safely
  const chatUser = useMemo(() => {
    return {
      id: (params.userId as string) || 'user-1',
      fullName: (params.userName as string) || 'Quan Luu',
      avatarUrl:
        (params.userAvatar as string) ||
        'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=300&auto=format&fit=crop&q=80',
      handle: (params.userHandle as string) || '@quanluu08',
      isVerified: true,
    };
  }, [params]);
  ...
  // Edge Swipe-to-Back PanResponder (Mép trái x <= 35)
        ...
        >
          ...
          >
            ...
            {messages.map((msg) => {
              ...
              return (
                ...
                >
                  {!isMe && <Image source={{ uri: chatUser.avatarUrl }} style={styles.bubbleAvatar} />}
          ...
          {showQuickPrompts && (
            <View style={styles.quickPromptsWrapper}>
              ...
              {/* Dismiss Button ✖️ */}
              <TouchableOpacity
                style={styles.dismissPromptsBtn}
                activeOpacity={0.7}
                onPress={() => setShowQuickPrompts(false)}
              >
                <Ionicons name="close" size={16} color={COLORS.grayText} />
              </TouchableOpacity>
            </View>
          )}

          {/* ── Pure Text Input Toolbar (Calibrated Bottom Inset) ── */}
          <View style={[styles.inputToolbarContainer, { paddingBottom: bottomPadding }]}>
            {!showQuickPrompts && (
              <TouchableOpacity
                style={styles.reopenPromptsBtn}
                activeOpacity={0.75}
