    ...
    return (bookings || [])
      ...
      .map((b) => {
        ...
        return {
          ...
          sportId: b.sportId ? String(b.sportId) : (b.venue && b.venue.sport ? String(b.venue.sport.id) : '1'),
          sportName: b.sportName || (b.venue && b.venue.sport ? b.venue.sport.name : 'Thể thao'),
