...
public class MatchmakingController {
    ...
    @PostMapping({"/join-requests/{id}/reject", "/rooms/{roomId}/join-requests/{id}/reject"})
    ...
    @PostMapping({"/join-requests/{id}/accept", "/rooms/{roomId}/join-requests/{id}/accept"})
    ...
    @PostMapping({"/matches/{matchId}/score", "/rooms/{matchId}/score"})
    ...
    @PostMapping({"/matches/{matchId}/confirm-score", "/rooms/{matchId}/confirm-score"})
    ...
    @PostMapping({"/matches/{matchId}/disagree-score", "/rooms/{matchId}/disagree-score"})
    ...
    @PostMapping({"/matches/{matchId}/propose-draw", "/rooms/{matchId}/propose-draw"})
    ...
    @PostMapping({"/matches/{matchId}/accept-draw", "/rooms/{matchId}/accept-draw"})
    ...
    @PostMapping({"/matches/{matchId}/dispute", "/rooms/{matchId}/dispute"})
