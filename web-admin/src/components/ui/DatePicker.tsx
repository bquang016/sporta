    ...
    return (
      <div className="relative w-full" ref={containerRef}>
        <Input
          ...
          prefixIcon={<CalendarIcon className="w-3.5 h-3.5 text-slate-400" />}
          className={cn("cursor-pointer bg-white text-xs font-semibold py-2", className)}
          inputClassName="cursor-pointer text-xs"
          labelClassName={labelClassName}
          placeholder="Chọn ngày"
          {...props}
        />
        {isOpen && (
          <div className="absolute left-0 z-[60] mt-1.5 w-[280px] bg-white border border-slate-200/80 rounded-2xl shadow-[0_12px_32px_rgba(0,0,0,0.15)] p-4 select-none font-sans animate-in fade-in zoom-in-95 duration-150">
            {/* Header */}
