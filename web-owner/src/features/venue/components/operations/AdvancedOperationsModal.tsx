      ...
      <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="p-5 border-t border-slate-100 bg-white flex justify-end gap-3">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-brand-emerald hover:bg-emerald-800 text-white font-extrabold text-xs shadow-md transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 cursor-pointer"
          >
