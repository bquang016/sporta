...
export const VenueOperatingStep = ({
  ...
  const handleAddPriceRule = () => {
    ...
    onCourtsChange(courts.map((c, idx) => {
                ...
                <div className="border border-slate-100 rounded-2xl p-4 bg-slate-50/20 space-y-4">
                  ...
                  <div className="space-y-3 bg-white border border-slate-200/80 rounded-2xl p-4 shadow-3xs">
                    ...
                    <button
                      ...
                      className="w-full py-2 bg-emerald-50 hover:bg-emerald-100 text-brand-emerald border border-emerald-150 font-extrabold text-[9px] rounded-lg cursor-pointer uppercase tracking-wider transition-all disabled:opacity-50"
                    >
                      Thêm quy tắc
                    </button>
                  </div>
                        ...
                        {activeCourt.priceRules.map((rule, ruleIdx) => (
                          ...
                          >
                            ...
                            <button
                              ...
                              className="p-1 rounded bg-red-50 text-red-500 border border-red-100 hover:bg-red-100 hover:text-red-700 cursor-pointer transition-all disabled:opacity-50"
                            >
