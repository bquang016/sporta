    ...
    >
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-1">
          ...
          <p>• Địa chỉ kinh doanh: {venueInfo.addressDetail ? `${venueInfo.addressDetail}, ` : ''}{venueInfo.ward}, {venueInfo.district}, {venueInfo.province}</p>
        </div>
        ...
        <p>1. Bên A cam kết thông tin về giá, giờ hoạt động và các chính sách (hủy lịch, hoàn tiền, đổi ca) do Bên A tự thiết lập trên hệ thống là chính xác và là một phần không thể tách rời của Hợp đồng này.</p>
            ...
            {isSigned && signatureData && (
              <div className="absolute top-16 left-1/2 -translate-x-1/2 w-56 border-2 border-red-600 rounded-lg p-3 bg-white/95 shadow-sm rotate-[-3deg] animate-[stampIn_0.3s_cubic-bezier(0.175,0.885,0.32,1.275)_forwards]" style={{ fontFamily: 'sans-serif' }}>
                <div className="border border-red-600/50 rounded p-1.5 text-center">
                  ...
                  <p className="text-red-700 font-bold text-sm my-1.5 uppercase">{personalInfo.fullName}</p>
