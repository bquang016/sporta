...
export const Tooltip = ({
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div 
          className={`absolute z-[100] px-2.5 py-1.5 text-[10px] font-black text-white bg-slate-900 rounded-lg whitespace-nowrap shadow-md pointer-events-none transition-all duration-200 scale-95 origin-center animate-fade-in ${positionClasses[position]} ${className}`}
        >
          {content}
